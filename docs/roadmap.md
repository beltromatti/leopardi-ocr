...
- implement canonical Markdown normalization
- ship baseline CLI and experiment scaffolding
...
- introduce expert routing and repair
- train latency-aware draft and verify models
- benchmark against open and commercial systems
