...
def stage_recipe(stage: str) -> PretrainStageConfig:
    ...
    recipes = {
        ...
        "p2_multimodal_core": PretrainStageConfig(
            ...
            data_mix=DataMixConfig(
                exact_pairs=0.58,
                synthetic_exact=0.08,
                structural_aux=0.08,
                table_aux=0.12,
                formula_aux=0.10,
                long_tail_aux=0.04,
                weak_label_discount=0.25,
            ),
            curriculum=CurriculumConfig(
                clean_phase_steps=4_000,
                transition_phase_steps=12_000,
                hard_phase_steps=20_000,
                hard_example_boost=1.20,
                pathological_boost=1.35,
        ...
        "p3_hard_curriculum": PretrainStageConfig(
            ...
            text_only=False,
            visual_mode="hard",
            data_bundle_ids=("p2_exact_core_v1", "p2_structural_aux_v1", "p3_hardcases_v1"),
            optimizer=optimizer,
            runtime=runtime,
            scheduler=SchedulerConfig(name="cosine", warmup_ratio=0.02, min_lr_ratio=0.2),
            data_mix=DataMixConfig(
                exact_pairs=0.32,
                synthetic_exact=0.30,
                structural_aux=0.08,
                table_aux=0.11,
                formula_aux=0.11,
                long_tail_aux=0.08,
